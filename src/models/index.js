...
const Subscription = sequelize.define('Subscription', {
  ...
  status: { type: DataTypes.ENUM('pending', 'active', 'paused', 'cancelled', 'expired'), defaultValue: 'active' },
...
const Payment = sequelize.define('Payment', {
  ...
  subscription_id: { type: DataTypes.INTEGER },
  amount: { type: DataTypes.DECIMAL(10, 2), allowNull: false },
  type: { type: DataTypes.ENUM('booking', 'subscription', 'refund', 'wallet_topup', 'order'), allowNull: false },
...
const OrderItem = sequelize.define('OrderItem', {
  ...
  price: { type: DataTypes.DECIMAL(10, 2), allowNull: false },
  // GST % snapshot at purchase time. Admin can change a product's gst_rate
  // later; a tax invoice must keep printing the rate the customer was charged.
